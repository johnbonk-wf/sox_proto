...
// Add support for .indexOf in MSIE 8 and below
...
+function(window, document, $) {
    ...
    if (isInputSupported && isTextareaSupported) {
        ...
        placeholder = prototype.placeholderMSIElt9 = function() {
            return this;
        };
    ...
    function setPlaceholder() {
        ...
        if (input.value === '') {
            ...
            placeholderText = typeof $input.attr('placeholder') !== 'undefined' ? $input.attr('placeholder') : $input.attr('data-placeholder');
...
+function(window, document, $) {
    ...
    Placeholder.prototype.init = function() {
        ...
        if (typeof this.element.value === 'undefined' || this.element.value === '') {
            this.$element
    ...
    $(document).ready(function() {
        ...
        var $dataPlaceholders = $(elementsToShimSelector).not('[type="number"]');
